...
module.exports = {
    ...
    execute: function (message, args) {
        ...
        if (args[0] === 'normal' && message.author.id === '607999934725357578')
            message.channel.send(embeds[1]).then(function (msg) {
                msg.react('🎧');
                msg.react('🔒');
                msg.react('🔹');
                msg.react('🎇');
        ...
        if (args[0] === 'games' && message.author.id === '607999934725357578')
            message.channel.send(embeds[2]).then(function (msg) {
                msg.react('🔮');
                msg.react('🛸');
                msg.react('🔪');
                msg.react('🏹');
...
function createEmbeds() {
    return {
        1: new discord_js_1.MessageEmbed()
        ...
        2: new discord_js_1.MessageEmbed()
