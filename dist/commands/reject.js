    ...
    execute: function (message, args, client, config) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            function sendSucessMessageAndRemoveMessage() {
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, message.channel.send(commands_reject_1.default.sucess)];
                            case 1:
                                thisMessage = _a.sent();
            ...
            function sendErrorMessageAndRemoveCommandMessage() {
                message.reply(commands_reject_1.default.notExistMessageReference)
                    .then(function (msg) { return setTimeout(function () { return msg.delete(); }, 1000 * 5); });
                message.delete();
            }
            function deleteSuggestionMessage() {
                var _a;
                db.get('suggestionsCache').remove({ id: (_a = referenceMessage.embeds[0].footer) === null || _a === void 0 ? void 0 : _a.text }).write();
            ...
            function alertSuggestionAuthor() {
                ...
                (_b = message.client.users.cache.get(userId)) === null || _b === void 0 ? void 0 : _b.send(commands_reject_1.default.suggestionReject);
            }
