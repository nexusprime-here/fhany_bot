...
/* If you reading this, remember to add automatically all channels for whitelist instead all channels for communlist */
/* We have 3 types of channel:
 * Whitelist: is a channel that everyone can mention the Fhany.
 * Commun: The mention of Fhany is only possible if the Fhany is active in chat, and the chat warn when the Fhany is Active
